...
Gem::Specification.new do |s|
  ...
  s.files       = ["bin/icersplicer", "lib/icersplicer.rb", "lib/globutils.rb", "lib/version.rb", "examples/keywords.ice", "examples/keywords-ruby.ice", "examples/files/example_data.sql", "examples/files/voc_dump.sql"]
